...
Feature: Dados Pessoais Contato
  ...
  Scenario: Contato Salvar Dados Sem Contato de Emergência Cadastrado
	  Given Eu Acesso A Pagina Fourmakers Home Dados Pessoais Minha Conta
	  When Eu Pressiono Entrar Com A Conta Da Microsoft
	  And Eu Pressiono Dados Pessoais
      And Eu Acesso A Tela Minha Conta
		And Eu Pressiono Menu Minha Conta E Contato
