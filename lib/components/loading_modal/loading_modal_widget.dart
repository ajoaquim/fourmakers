...
class LoadingModalWidget extends StatefulWidget {
  ...
  @override
  _LoadingModalWidgetState createState() => _LoadingModalWidgetState();
}
              ...
              children: [
                ...
                Container(
                  ...
                  child: Lottie.network(
                    'https://assets5.lottiefiles.com/packages/lf20_d9wImAFTrS.json',
                    width: 500.0,
                    height: 400.0,
                    fit: BoxFit.contain,
                    animate: true,
                ...
                Padding(
                  ...
                  child: AutoSizeText(
                    'Aguarde um momento, estamos criando a melhor experiência para você!',
