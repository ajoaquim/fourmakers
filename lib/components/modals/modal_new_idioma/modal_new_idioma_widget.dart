...
import 'modal_new_idioma_model.dart';
export 'modal_new_idioma_model.dart';

class ModalNewIdiomaWidget extends StatefulWidget {
  const ModalNewIdiomaWidget({
    Key? key,
    this.metodologia,
  }) : super(key: key);
  ...
  @override
  _ModalNewIdiomaWidgetState createState() => _ModalNewIdiomaWidgetState();
}

class _ModalNewIdiomaWidgetState extends State<ModalNewIdiomaWidget> {
  late ModalNewIdiomaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalNewIdiomaModel());
                                      ...
                                      Container(
                                        ...
                                        child: FutureBuilder<ApiCallResponse>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final listViewListaIdiomasResponse =
                                                snapshot.data!;
                                            return Builder(
                                              builder: (context) {
                                                final idiomas = getJsonField(
                                                  listViewListaIdiomasResponse
                                                      .jsonBody,
                                                  r'''$.Idioma''',
                                                ).toList();
                                                return ListView.builder(
                                                  ...
                                                  itemBuilder:
                                                      (context, idiomasIndex) {
                                                    final idiomasItem =
                                                        idiomas[idiomasIndex];
                                                    return Column(
                                                      mainAxisSize:
                                                          MainAxisSize.max,
                                                      children: [
