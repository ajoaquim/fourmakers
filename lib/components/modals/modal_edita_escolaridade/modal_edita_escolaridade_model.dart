...
class ModalEditaEscolaridadeModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (EditaEscolaridadeColaborador)] action in Button widget.
  ApiCallResponse? editaEscolaridade;
