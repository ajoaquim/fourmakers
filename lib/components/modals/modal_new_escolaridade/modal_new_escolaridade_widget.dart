...
import 'modal_new_escolaridade_model.dart';
export 'modal_new_escolaridade_model.dart';

class ModalNewEscolaridadeWidget extends StatefulWidget {
  const ModalNewEscolaridadeWidget({Key? key}) : super(key: key);

  @override
  _ModalNewEscolaridadeWidgetState createState() =>
      _ModalNewEscolaridadeWidgetState();
}

class _ModalNewEscolaridadeWidgetState
    extends State<ModalNewEscolaridadeWidget> {
  late ModalNewEscolaridadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalNewEscolaridadeModel());

    _model.formInstituicaoController ??= TextEditingController();
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  'Adicionar formação - ${FFAppState().escolaridadeArea}',
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if ((_model.addEscolaridade?.succeeded ??
                                        true)) {
                                      Navigator.pop(context);
                                      await showDialog(
                                        context: context,
