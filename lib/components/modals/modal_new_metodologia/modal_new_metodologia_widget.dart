...
import 'modal_new_metodologia_model.dart';
export 'modal_new_metodologia_model.dart';

class ModalNewMetodologiaWidget extends StatefulWidget {
  const ModalNewMetodologiaWidget({
    Key? key,
    this.metodologia,
  }) : super(key: key);
  ...
  @override
  _ModalNewMetodologiaWidgetState createState() =>
      _ModalNewMetodologiaWidgetState();
}

class _ModalNewMetodologiaWidgetState extends State<ModalNewMetodologiaWidget> {
  late ModalNewMetodologiaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalNewMetodologiaModel());
                                      ...
                                      Container(
                                        ...
                                        child: FutureBuilder<ApiCallResponse>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final listViewListarMetodologiasResponse =
                                                snapshot.data!;
                                            return Builder(
                                              builder: (context) {
                                                final metodologias =
                                                    getJsonField(
                                                  listViewListarMetodologiasResponse
                                                      .jsonBody,
                                                  r'''$.metodologia''',
                                                ).toList();
