...
class ModalAddDependenteModel extends FlutterFlowModel {
  ...
  // State field(s) for dependData widget.
  TextEditingController? dependDataController;
  final dependDataMask = MaskTextInputFormatter(mask: '##/##/####');
  String? Function(BuildContext, String?)? dependDataControllerValidator;
  String? _dependDataControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Campo obrigatório';
    }
  ...
  // Stores action output result for [Backend Call - API (AdicionaDependente)] action in Button widget.
