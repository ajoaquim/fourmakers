...
import 'modal_new_soft_skills_model.dart';
export 'modal_new_soft_skills_model.dart';

class ModalNewSoftSkillsWidget extends StatefulWidget {
  const ModalNewSoftSkillsWidget({
    Key? key,
    this.hardskills,
  }) : super(key: key);
  ...
  @override
  _ModalNewSoftSkillsWidgetState createState() =>
      _ModalNewSoftSkillsWidgetState();
}

class _ModalNewSoftSkillsWidgetState extends State<ModalNewSoftSkillsWidget> {
  late ModalNewSoftSkillsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalNewSoftSkillsModel());
                                      ...
                                      Container(
                                        ...
                                        child: FutureBuilder<ApiCallResponse>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final listViewListarSoftSkillsResponse =
                                                snapshot.data!;
                                            return Builder(
                                              builder: (context) {
                                                final softskills = getJsonField(
                                                  listViewListarSoftSkillsResponse
                                                      .jsonBody,
                                                  r'''$.softskill''',
                                                ).toList();
