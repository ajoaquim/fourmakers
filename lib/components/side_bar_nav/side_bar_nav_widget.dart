...
class SideBarNavWidget extends StatefulWidget {
  const SideBarNavWidget({
    ...
    Color? bookText,
    Color? bookBG,
  })  : this.sevenBg = sevenBg ?? Colors.white,
        this.sevenText = sevenText ?? const Color(0xFF4A4A4A),
        this.eightBg = eightBg ?? Colors.white,
        this.eightText = eightText ?? const Color(0xFF4A4A4A),
        this.bookText = bookText ?? const Color(0xFF626468),
        this.bookBG = bookBG ?? Colors.white,
        super(key: key);
  ...
  final Color? sixBG;
  final Color sevenBg;
  final Color sevenText;
  final Color eightBg;
  final Color eightText;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if ((FFAppState().userid.toString() == '128') ||
                  (FFAppState().userid.toString() == '685') ||
                  (FFAppState().userid.toString() == '1132') ||
                  (FFAppState().userid.toString() == '183') ||
                  (FFAppState().userid.toString() == '3844') ||
                  (FFAppState().userid.toString() == '2153') ||
                  (FFAppState().userid.toString() == '2360'))
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 0.0, 0.0),
                  child: InkWell(
                    splashColor: Colors.transparent,
