...
import 'supports_colab_model.dart';
export 'supports_colab_model.dart';

class SupportsColabWidget extends StatefulWidget {
  const SupportsColabWidget({Key? key}) : super(key: key);

  @override
  _SupportsColabWidgetState createState() => _SupportsColabWidgetState();
}

class _SupportsColabWidgetState extends State<SupportsColabWidget> {
  late SupportsColabModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SupportsColabModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.ticketsResponse = await SupportGroup.getAllTicketsColabCall.call(
        id: FFAppState().userid,
      );
      if ((_model.ticketsResponse?.succeeded ?? true)) {
        setState(() {
          FFAppState().allTicketsColabJSON = functions
              .filterTicketsByStatus(
                  (_model.ticketsResponse?.jsonBody ?? ''), 'Pendente')
              .toList()
              .cast<dynamic>();
          FFAppState().allTicketsConcluidosColabJSON = functions
              .filterTicketsByStatus(
                    ...
                    if (responsiveVisibility(
                      ...
                      wrapWithModel(
                        ...
                        child: SideBarNavWidget(
                          ...
                          eightBg: Colors.white,
                          eightText: FlutterFlowTheme.of(context).secondaryText,
                        ),
                      ),
                    Expanded(
                      child: Padding(
