...
import 'detalhes_acompanhamentos_book_model.dart';
export 'detalhes_acompanhamentos_book_model.dart';

class DetalhesAcompanhamentosBookWidget extends StatefulWidget {
  const DetalhesAcompanhamentosBookWidget({
    Key? key,
    int? colabId,
    this.cpf,
    this.colab,
  })  : this.colabId = colabId ?? 0,
        super(key: key);
  ...
  @override
  _DetalhesAcompanhamentosBookWidgetState createState() =>
      _DetalhesAcompanhamentosBookWidgetState();
}

class _DetalhesAcompanhamentosBookWidgetState
    extends State<DetalhesAcompanhamentosBookWidget> {
  late DetalhesAcompanhamentosBookModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesAcompanhamentosBookModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.showMeResponse?.succeeded ?? true)) {
        _model.getAcompanhamentosResponse =
            await BookGroup.getAcompanhamentosByColabCall.call(
                                                                          ...
                                                                          return GestureDetector(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: ModalAdicionarAnotacaoWidget(
                                                                                  id: widget.colabId,
                                                                                ),
                                                                              ),
                                                                            ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration:
                                                                          ...
                                                                          enabledBorder:
                                                                            ...
                                                                            borderSide:
                                                                                BorderSide(
                                                                              color: FlutterFlowTheme.of(context).borderDefault,
                                                                              width: 1.0,
                                                                            ),
                                                                            borderRadius:
                                                                              ...
                                                                              await showModalBottomSheet(
                                                                                ...
                                                                                builder: (context) {
                                                                                  return GestureDetector(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      padding: MediaQuery.of(context).viewInsets,
                                                                                      child: ModalShowPontosForcaWidget(
                                                                                        id: 0,
                                                                                        movimentacao: getJsonField(
                                                                                          detalhesColaboradorItem,
                                                                                          r'''$.movimentacao''',
                                                                                        ).toString(),
                                                                                        gestor: getJsonField(
                                                                              ...
                                                                              await showModalBottomSheet(
                                                                                ...
                                                                                builder: (context) {
                                                                                  return GestureDetector(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      padding: MediaQuery.of(context).viewInsets,
                                                                                      child: ModalShowPontosMelhoriaWidget(
                                                                                        movimentacao: getJsonField(
                                                                                          detalhesColaboradorItem,
                                                                                          r'''$.movimentacao''',
                                                                                        ).toString(),
                                                                              ...
                                                                              await showModalBottomSheet(
                                                                                ...
                                                                                builder: (context) {
                                                                                  return GestureDetector(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      padding: MediaQuery.of(context).viewInsets,
                                                                                      child: ModalShowObservacoesWidget(
                                                                                        movimentacao: getJsonField(
                                                                                          detalhesColaboradorItem,
                                                                                          r'''$.movimentacao''',
                                                                                        ).toString(),
                                                                                        observacacoes: getJsonField(
                                                                                          detalhesColaboradorItem,
                                                                                          r'''$.obs_gerais''',
                                                                                        ).toString(),
                                                                                        gestor: getJsonField(
