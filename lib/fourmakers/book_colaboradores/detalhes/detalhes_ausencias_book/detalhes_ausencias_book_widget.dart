...
import '/fourmakers/book_colaboradores/modais/modal_adicionar_ausencia/modal_adicionar_ausencia_widget.dart';
...
import 'detalhes_ausencias_book_model.dart';
export 'detalhes_ausencias_book_model.dart';

class DetalhesAusenciasBookWidget extends StatefulWidget {
  const DetalhesAusenciasBookWidget({
    Key? key,
    this.colabId,
    this.cpf,
    this.colab,
  ...
  @override
  _DetalhesAusenciasBookWidgetState createState() =>
      _DetalhesAusenciasBookWidgetState();
}

class _DetalhesAusenciasBookWidgetState
    extends State<DetalhesAusenciasBookWidget> {
  late DetalhesAusenciasBookModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesAusenciasBookModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.showMeResponse?.succeeded ?? true)) {
        _model.getAusenciasResponse =
            await BookGroup.getAusenciasByColabCall.call(
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Projeto: Fourmakers / Instituicional',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                                .override(
                                                                        ...
                                                                        return GestureDetector(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: ModalAdicionarAusenciaWidget(
                                                                                colabId: widget.colabId,
                                                                              ),
                                                                            ),
                                                                          ),
                                                              ...
                                                              rows: (ausencia
                                                                  ...
                                                                  .mapIndexed((ausenciaIndex,
                                                                      ...
                                                                      [
                                                                        ...
                                                                        Text(
                                                                          functions
                                                                              .unixTimeStampToDateString(getJsonField(
                                                                            ausenciaItem,
                                                                            r'''$.data_inicio''',
                                                                          )),
                                                                          style: FlutterFlowTheme.of(context)
