...
import 'salarios_book_model.dart';
export 'salarios_book_model.dart';

class SalariosBookWidget extends StatefulWidget {
  const SalariosBookWidget({Key? key}) : super(key: key);

  @override
  _SalariosBookWidgetState createState() => _SalariosBookWidgetState();
}

class _SalariosBookWidgetState extends State<SalariosBookWidget> {
  late SalariosBookModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SalariosBookModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.showMeResponse?.succeeded ?? true)) {
        _model.getSalariosResponse = await BookGroup.getSalariosGestorCall.call(
