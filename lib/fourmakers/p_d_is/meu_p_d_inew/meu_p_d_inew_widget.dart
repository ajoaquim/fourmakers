...
import 'meu_p_d_inew_model.dart';
export 'meu_p_d_inew_model.dart';

class MeuPDInewWidget extends StatefulWidget {
  const MeuPDInewWidget({Key? key}) : super(key: key);

  @override
  _MeuPDInewWidgetState createState() => _MeuPDInewWidgetState();
}

class _MeuPDInewWidgetState extends State<MeuPDInewWidget>
    with TickerProviderStateMixin {
  late MeuPDInewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeuPDInewModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.apiToken?.succeeded ?? true)) {
        ...
        if ((_model.apiResultMyPDI?.succeeded ?? true)) {
          ...
          setState(() {
            _model.meusPDIs = (_model.apiResultMyPDI?.jsonBody ?? '');
          });
        }
      } else {
        await showDialog(
