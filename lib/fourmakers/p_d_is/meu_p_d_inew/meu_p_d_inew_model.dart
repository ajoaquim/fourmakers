...
class MeuPDInewModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (showMe)] action in meuPDInew widget.
  ApiCallResponse? apiToken;
  // Stores action output result for [Backend Call - API (listPDI)] action in meuPDInew widget.
