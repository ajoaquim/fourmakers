...
import 'pditime_model.dart';
export 'pditime_model.dart';

class PditimeWidget extends StatefulWidget {
  const PditimeWidget({
    Key? key,
    this.modal,
  }) : super(key: key);
  ...
  @override
  _PditimeWidgetState createState() => _PditimeWidgetState();
}

class _PditimeWidgetState extends State<PditimeWidget>
    with TickerProviderStateMixin {
  late PditimeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PditimeModel());
