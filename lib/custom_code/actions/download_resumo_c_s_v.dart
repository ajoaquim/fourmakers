...
dynamic downloadResumoCSV(dynamic relatorio, String token, double taxa,
    double valorTaxa, double totalTaxa, String inicio, String fim) {
  downloadFile(relatorio, token, taxa, valorTaxa, totalTaxa, inicio, fim);
}

void downloadFile(dynamic relatorio, String token, double taxa,
    double valorTaxa, double totalTaxa, String inicio, String fim) async {
  Dio dio = Dio();
  ...
  try {
    ...
    Response response = await dio.post(
      'https://xare-axod-hky2.b2.xano.io/api:itPnww4x/pagamento/exportar/resumo/',
      data: data,
      options: options,
    );
