...
dynamic downloadCSV(String token, int empresaid, int template) {
  downloadFile(token, empresaid, template);
}

void downloadFile(String token, int empresaid, int template) async {
  Dio dio = Dio();
  ...
  try {
    ...
    Response response = await dio.post(
      'https://xare-axod-hky2.b2.xano.io/api:itPnww4x/csv/exportar/apontamentos-t$template/',
      data: data,
      options: options,
    );
    ...
    String savePath = '$downloadsPath/apontamentos.csv';
