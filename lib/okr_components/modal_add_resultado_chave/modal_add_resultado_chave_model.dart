...
class ModalAddResultadoChaveModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (addResultadoChave)] action in Button widget.
  ApiCallResponse? addResultado;
