...
import 'vagasv1like_model.dart';
export 'vagasv1like_model.dart';

class Vagasv1likeWidget extends StatefulWidget {
  const Vagasv1likeWidget({Key? key}) : super(key: key);

  @override
  _Vagasv1likeWidgetState createState() => _Vagasv1likeWidgetState();
}

class _Vagasv1likeWidgetState extends State<Vagasv1likeWidget> {
  late Vagasv1likeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Vagasv1likeModel());
