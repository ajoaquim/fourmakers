...
import 'vagasv1modal2_model.dart';
export 'vagasv1modal2_model.dart';

class Vagasv1modal2Widget extends StatefulWidget {
  const Vagasv1modal2Widget({Key? key}) : super(key: key);

  @override
  _Vagasv1modal2WidgetState createState() => _Vagasv1modal2WidgetState();
}

class _Vagasv1modal2WidgetState extends State<Vagasv1modal2Widget> {
  late Vagasv1modal2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Vagasv1modal2Model());
