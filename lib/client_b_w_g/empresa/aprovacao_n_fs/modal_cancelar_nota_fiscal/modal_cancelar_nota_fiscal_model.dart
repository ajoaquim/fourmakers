...
class ModalCancelarNotaFiscalModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (cancelarNotaFiscal)] action in Button widget.
  ApiCallResponse? apiResultrz8;
