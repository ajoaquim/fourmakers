...
class ModalAlterarHorasApontamentoModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (editarHorasApontamento)] action in Button widget.
  ...
  ApiCallResponse? apontamentosReload2;
