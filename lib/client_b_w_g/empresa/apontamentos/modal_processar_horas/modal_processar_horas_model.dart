...
class ModalProcessarHorasModel extends FlutterFlowModel {
  ...
  ApiCallResponse? apiResultao100;
  // Stores action output result for [Backend Call - API (ProcessarHoras)] action in Button widget.
  ApiCallResponse? apiResultao9;
  // Stores action output result for [Backend Call - API (EnviarInstruProcessar)] action in Button widget.
  ApiCallResponse? apiResultbws;
