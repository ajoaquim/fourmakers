...
import 'apontamentos_empresa_model.dart';
export 'apontamentos_empresa_model.dart';

class ApontamentosEmpresaWidget extends StatefulWidget {
  const ApontamentosEmpresaWidget({Key? key}) : super(key: key);

  @override
  _ApontamentosEmpresaWidgetState createState() =>
      _ApontamentosEmpresaWidgetState();
}

class _ApontamentosEmpresaWidgetState extends State<ApontamentosEmpresaWidget> {
  late ApontamentosEmpresaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ApontamentosEmpresaModel());
