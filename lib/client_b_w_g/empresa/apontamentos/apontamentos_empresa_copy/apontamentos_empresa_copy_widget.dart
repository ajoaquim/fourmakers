...
import 'apontamentos_empresa_copy_model.dart';
export 'apontamentos_empresa_copy_model.dart';

class ApontamentosEmpresaCopyWidget extends StatefulWidget {
  const ApontamentosEmpresaCopyWidget({Key? key}) : super(key: key);

  @override
  _ApontamentosEmpresaCopyWidgetState createState() =>
      _ApontamentosEmpresaCopyWidgetState();
}

class _ApontamentosEmpresaCopyWidgetState
    extends State<ApontamentosEmpresaCopyWidget> {
  late ApontamentosEmpresaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ApontamentosEmpresaCopyModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apontamentoResponse =
          await EmpresaGroup.getApontamentosPendentesEmpresaCall.call(
        idEmpresa: getJsonField(
          FFAppState().showMeDataEmpresa,
          r'''$.id''',
        ),
      );
      if ((_model.apontamentoResponse?.succeeded ?? true)) {
        FFAppState().update(() {
          FFAppState().apontamentosEmpresaJSON =
              (_model.apontamentoResponse?.jsonBody ?? '')
                  .toList()
                  .cast<dynamic>();
          FFAppState().apontamentosEmpresaJSONTodos =
              (_model.apontamentoResponse?.jsonBody ?? '')
                  .toList()
                  .cast<dynamic>();
          FFAppState().aprovarHorasList = [];
        });
      }
    });
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            ...
                                            if ((_model.apontamentoResponse2
                                                    ?.succeeded ??
                                                true)) {
                                              FFAppState().update(() {
                                                FFAppState()
                                                        .apontamentosEmpresaJSON =
                                                    (_model.apontamentoResponse2
                                                                ?.jsonBody ??
                                                            '')
                                                        .toList()
                                                  ...
                                                  .mapIndexed((apontamentoIndex,
                                                      ...
                                                      [
                                                                ...
                                                                if (!functions
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        if (functions.checkIdAprovarHorasItem(
                                                                                getJsonField(
                                                                                  apontamentoItem,
                                                                                  r'''$.id''',
                                                                                ),
                                                                                'Recusado',
                                                                                FFAppState().aprovarHorasList.toList()) ==
                                                                            true) {
                                                                          setState(
                                                                              () {
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            FFAppState().addToAprovarHorasList(functions.createAprovarHorasItem(
                                                                                getJsonField(
                                                                                  apontamentoItem,
                                                                                  r'''$.id''',
                                                                                ),
                                                                            ...
                                                                            return GestureDetector(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: ModalInserirComentarioAprovarHorasItemWidget(
                                                                                    id: getJsonField(
                                                                                      apontamentoItem,
                                                                                      r'''$.id''',
                                                                                    ),
                                                                                    coment: functions.getComentarioAprovarHorasItem(
                                                                                        FFAppState().aprovarHorasList.toList(),
                                                                                        getJsonField(
                                                                                          apontamentoItem,
                                                                                          r'''$.id''',
                                                                      ...
                                                                      return GestureDetector(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                ModalGrupoApontamentosWidget(
                                                                              id: getJsonField(
                                                                                apontamentoItem,
                                                                                r'''$.apontamentos_grupo_id''',
                                                                              ),
                                                                            ),
                                                                          ),
                                                                        ),
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        functions
                                                                            .countInt(getJsonField(
                                                                              apontamentoItem,
                                                                              r'''$.grupo.apontamentos_id''',
                                                                            )!)
                                                                            .toString(),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium,
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            if (functions
                                                                .checkHasCommentaryAprovarHorasItem(
                                                                    getJsonField(
                                                                      apontamentoItem,
                                                                      r'''$.id''',
                                                                    ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            height:
                                                                                MediaQuery.of(context).size.height * 1.0,
                                                                            child:
                                                                                ModalInserirComentarioAprovarHorasItemWidget(
                                                                              id: getJsonField(
                                                                                apontamentoItem,
                                                                                r'''$.id''',
                                                                              ),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      height: MediaQuery.of(context)
                                                                          ...
                                                                          1.0,
                                                                      child:
                                                                          ModalAlterarHorasApontamentoWidget(
                                                                        idApontamento:
                                                                            getJsonField(
                                                                          apontamentoItem,
                                                                          r'''$.id''',
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Container(
                                                          height: MediaQuery.of(
                                                              ...
                                                              1.0,
                                                          child:
                                                              ModalExportarApontamentosWidget(),
                                                        ),
                                                      ),
                                                    );
                                                  },
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Container(
                                                          height: MediaQuery.of(
                                                              ...
                                                              1.0,
                                                          child:
                                                              ModalImportarApontamentosWidget(),
                                                        ),
                                                      ),
                                                    );
                                                  },
