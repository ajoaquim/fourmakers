...
import 'beneficios_interesses_prestador_model.dart';
export 'beneficios_interesses_prestador_model.dart';

class BeneficiosInteressesPrestadorWidget extends StatefulWidget {
  const BeneficiosInteressesPrestadorWidget({Key? key}) : super(key: key);

  @override
  _BeneficiosInteressesPrestadorWidgetState createState() =>
      _BeneficiosInteressesPrestadorWidgetState();
}

class _BeneficiosInteressesPrestadorWidgetState
    extends State<BeneficiosInteressesPrestadorWidget> {
  late BeneficiosInteressesPrestadorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BeneficiosInteressesPrestadorModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultshc =
          await BeneficiosGroup.getBeneficiosPrestadorInteressesCall.call(
                                      ...
                                      children: [
                                        ...
                                        FutureBuilder<ApiCallResponse>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final wrapGetBeneficiosPrestadorInteressesResponse =
                                                snapshot.data!;
                                            return Builder(
                                              builder: (context) {
                                                final beneficio =
                                                    wrapGetBeneficiosPrestadorInteressesResponse
                                                        .jsonBody
                                                        .toList();
