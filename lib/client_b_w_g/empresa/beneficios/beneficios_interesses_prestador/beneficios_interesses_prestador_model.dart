...
class BeneficiosInteressesPrestadorModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (getBeneficiosPrestadorInteresses)] action in beneficiosInteressesPrestador widget.
