...
import 'modal_alterar_data_pagamento_model.dart';
export 'modal_alterar_data_pagamento_model.dart';

class ModalAlterarDataPagamentoWidget extends StatefulWidget {
  const ModalAlterarDataPagamentoWidget({
    Key? key,
    this.id,
  }) : super(key: key);
  ...
  @override
  _ModalAlterarDataPagamentoWidgetState createState() =>
      _ModalAlterarDataPagamentoWidgetState();
}

class _ModalAlterarDataPagamentoWidgetState
    extends State<ModalAlterarDataPagamentoWidget> {
  late ModalAlterarDataPagamentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalAlterarDataPagamentoModel());
