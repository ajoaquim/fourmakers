...
import 'pagamentos_empresa_copy_model.dart';
export 'pagamentos_empresa_copy_model.dart';

class PagamentosEmpresaCopyWidget extends StatefulWidget {
  const PagamentosEmpresaCopyWidget({Key? key}) : super(key: key);

  @override
  _PagamentosEmpresaCopyWidgetState createState() =>
      _PagamentosEmpresaCopyWidgetState();
}

class _PagamentosEmpresaCopyWidgetState
    extends State<PagamentosEmpresaCopyWidget> {
  late PagamentosEmpresaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagamentosEmpresaCopyModel());
