...
import 'home_p_j_model.dart';
export 'home_p_j_model.dart';

class HomePJWidget extends StatefulWidget {
  const HomePJWidget({Key? key}) : super(key: key);

  @override
  _HomePJWidgetState createState() => _HomePJWidgetState();
}

class _HomePJWidgetState extends State<HomePJWidget> {
  late HomePJModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePJModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultsiu = await PjGroup.showMePJCall.call(
