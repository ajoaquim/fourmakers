...
class ChangePasswordEmpresaModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (magicLoginEmpresa)] action in changePasswordEmpresa widget.
  ApiCallResponse? apiResult4js;
  // Stores action output result for [Backend Call - API (empresaShowMe)] action in changePasswordEmpresa widget.
  ...
  // Stores action output result for [Backend Call - API (changePasswordEmpresa)] action in Button widget.
