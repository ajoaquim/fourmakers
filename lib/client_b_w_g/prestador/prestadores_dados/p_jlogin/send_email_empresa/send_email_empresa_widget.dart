...
import 'send_email_empresa_model.dart';
export 'send_email_empresa_model.dart';

class SendEmailEmpresaWidget extends StatefulWidget {
  const SendEmailEmpresaWidget({Key? key}) : super(key: key);

  @override
  _SendEmailEmpresaWidgetState createState() => _SendEmailEmpresaWidgetState();
}

class _SendEmailEmpresaWidgetState extends State<SendEmailEmpresaWidget> {
  late SendEmailEmpresaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendEmailEmpresaModel());
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        validator: _model
                                            ...
                                            .asValidator(context),
                                        inputFormatters: [_model.fieldCPFMask],
                                      ),
                                    ),
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
