...
import 'mapa_projetos_model.dart';
export 'mapa_projetos_model.dart';

class MapaProjetosWidget extends StatefulWidget {
  const MapaProjetosWidget({Key? key}) : super(key: key);

  @override
  _MapaProjetosWidgetState createState() => _MapaProjetosWidgetState();
}

class _MapaProjetosWidgetState extends State<MapaProjetosWidget> {
  late MapaProjetosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MapaProjetosModel());
